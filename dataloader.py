...
class ct_dataset(Dataset):
    def __init__(self, data_path, min_value=-1024.0, max_value=3072.0, augmentation=False):
...
#      ct_dataset = ct_dataset(data_path='/scratch/kejh66/LDCT_2016/npz_files/test_dataset/1mm', augmentation=True)
